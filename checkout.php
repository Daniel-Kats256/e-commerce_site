				...
				<form action="check.php" method="post">
		          <div class="p-3 p-lg-5 border bg-white">
		            ...
		            <div class="form-group mt-3">
		              <input type="text" class="form-control" placeholder="Apartment, suite, unit etc. (optional)" name = "c_address2">
		            </div>
					...
					<div class="form-group">
		              <div>
							<br>
							<button class="btn btn-black btn-lg py-3 btn-block" type="submit" name="create">submit</button>
